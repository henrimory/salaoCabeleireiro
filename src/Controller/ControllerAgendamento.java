...
public class ControllerAgendamento {
    ...
    //UTIL
    public Agendamento validaCampos(Reg_Agendamento telaCadastro, String data, String hora, String usuario, String senha){
    ...
    public Agendamento validaCampos(Altera_Agendamento telaAltera, String data, String hora, String usuario, String senha){
        if(data.isEmpty() || hora.isEmpty()){
            if(data.isEmpty()){
    ...
    public void validaCamposCad(String data, String hora, String codigo, String usuario, String senha){
        Agendamento agendamento = validaCampos(telaRegistro, data, hora, usuario, senha);
    ...
    public void validaCamposAlt(String data, String hora, String codigo, String usuario, String senha){
        Agendamento agendamento = validaCampos(telaAltera, data, hora, usuario, senha);
        if(agendamento == null){
        }else{
